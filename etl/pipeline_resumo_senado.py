    ...
    async with httpx.AsyncClient() as client:
        for prop in proposicoes:
            ...
            try:
                ...
                if not texto:
                    logger.warning(f"Proposição {proposicao_id}: PDF sem texto extraível ou corrompido.")
                ...
                qdrant_client.upsert(
                    ...
                    points=[{
                        ...
                        "payload": {
                            ...
                            "data_votacao": converter_data_para_timestamp_sp(data_votacao),
                            "casa": "senado"
                        }
                    }]
                )
                ...
                supabase_client.table("senado_proposicoes").update({"resumo_executivo": resumo}).eq("id", id_uuid).execute()
                total += 1
