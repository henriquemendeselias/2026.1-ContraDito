...
def transformar_proposicao(payload: Dict[str, Any], tramitacoes: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    """
    ...
    chave_negocio = formatar_chave_negocio(payload.get("siglaTipo"), payload.get("numero"), payload.get("ano"))
