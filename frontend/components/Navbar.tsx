import Link from "next/link";                                                                                                                                                    
    import { List, GitCompareArrows, Building2, MessageSquare, FileText } from "lucide-react";                                                                                       
        ...
        <nav className="fixed top-0 inset-x-0 z-50 h-14 border-b border-rim/20 bg-canvas/90 backdrop-blur-sm">                                                                       
          <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 flex items-center justify-between">                                                                                  
            ...
            <div className="flex items-center gap-1">                                                                                                                                
              ...
              <Link
                href="/comparacao"
                className="px-3 py-1.5 inline-flex items-center gap-1.5 text-sm text-mid hover:text-bright border border-white/10 rounded-full transition-colors hover:border-       
  white/20"
              >
