// TIPOS LEGADOS (com score) — isolados para as páginas ainda antigas
// (/politico/[id] e /comparacao) continuarem compilando até serem reescritas na Fase 2.
// NÃO usar em código novo. O canônico (sem score) é `@/lib/types`.
