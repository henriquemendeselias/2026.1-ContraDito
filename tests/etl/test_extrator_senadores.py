...
from etl.extrator_senadores import extrair_senadores, executar_pipeline_senadores

@respx.mock
def test_extrair_senadores_offset_e_basico():
    """
...
@respx.mock
def test_extrair_senadores_unico_senador_isinstance():
    """
...
@respx.mock
def test_extrair_senadores_conversao_status():
    """
...
@respx.mock
def test_extrair_senadores_inclui_suplentes_sem_exercicio():
    """
...
@respx.mock
def test_extrair_senadores_encontra_exercicio_correto_na_lista():
    """
...
@respx.mock
@patch("time.sleep")
def test_executar_pipeline_senadores_sucesso(mock_sleep):
    """
    ...
    assert args_log[0]["nome_rotina"] == "extrator_senadores"