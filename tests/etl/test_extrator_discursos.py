...
from etl.extrator_discursos import extrair_pagina_discursos, executar_extracao_deputado, executar_pipeline_completo

@respx.mock
def test_extrair_pagina_discursos_paginacao():
    """
...
@respx.mock
@patch("time.sleep")
def test_extrair_pagina_discursos_retry_sucesso(mock_sleep):
    """
...
@respx.mock
@patch("time.sleep")
def test_executar_extracao_deputado_com_paginacao_e_upsert(mock_sleep):
    """
...
@respx.mock
@patch("time.sleep")
def test_executar_extracao_deputado_remove_duplicatas(mock_sleep):
    """
...
def test_executar_pipeline_completo_sucesso(mock_sleep):
    ...
    assert log_enviado["nome_rotina"] == "extrator_discursos"
