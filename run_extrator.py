...
from etl.extrator_deputados import executar_pipeline_completo
from etl.extrator_senadores import executar_pipeline_senadores
...
if not SUPABASE_URL or not SUPABASE_KEY:
    raise ValueError("As variáveis SUPABASE_URL e SUPABASE_KEY precisam estar definidas no .env")
