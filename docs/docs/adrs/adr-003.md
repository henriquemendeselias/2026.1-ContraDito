# ADR 003: Diretório Unificado (`/diretorio`) com Fetch-All e Paginação Client-Side
...
Com a virada de produto de *ranking de coerência* para **portal de consulta**, a rota
**`/diretorio`** passou a exibir Câmara e Senado numa lista única com três modos de
visualização (**Todos / Só Câmara / Só Senado**). A Home (`/`) é apenas vitrine/preview
e navega para `/diretorio`. A API, porém, não oferece endpoint unificado:
