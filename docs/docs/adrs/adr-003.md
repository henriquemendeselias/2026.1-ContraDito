...
O dataset é pequeno: Câmara ≈ 513 + Senado ≈ 81 ≈ **594 registros** de campos leves, e
os endpoints de listagem têm cache de 1h no servidor.
...
!!! warning "Carga inicial maior"
    ...
    requisições (~594 registros). O custo é amortizado pelo cache de 1h dos endpoints
