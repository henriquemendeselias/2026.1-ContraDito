...
Bem-vindo ao **ContraDito**! A plataforma foi desenhada para ser rápida, intuitiva e direta ao ponto. Abaixo, explicamos como navegar pelas principais funcionalidades.
...
Ao selecionar um político, você acessa seu perfil individual em formato de dossiê:

- **Perfil Oficial:** Informações gerais extraídas das bases de dados governamentais.
- **Análise de Votações:** Todas as votações processadas pelo sistema listadas no perfil.
- **Justificativa da IA:** Para cada voto, a interface exibe o posicionamento oficial (Sim/Não), a classificação de coerência ou incoerência, e uma **justificativa textual gerada pela IA** explicando o porquê do veredito com base nos discursos anteriores do político.
