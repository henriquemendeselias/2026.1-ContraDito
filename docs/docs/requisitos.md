...
* **RNF07 - Motor de Inferência Self-Hosted:** A avaliação semântica das posturas parlamentares deve ser executada obrigatoriamente pelo modelo de linguagem Llama 3.1 8B em infraestrutura dedicada com aceleração de GPU (google colab), garantindo que a arquitetura não dependa de cobranças por token de APIs comerciais externas.
